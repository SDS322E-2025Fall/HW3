...
Using `tidyverse` functions on `myeurope`, only keep information for the population growth in 2017 then compare the population growth per country with `ggplot` using `geom_col()`. Use the `fct_reorder()` function to order countries in order of population growth. Which country in Europe had the lowest population growth in 2017?
